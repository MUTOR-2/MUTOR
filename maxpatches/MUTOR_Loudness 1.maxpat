...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 446.5, 549.0, 83.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 811.5, 97.0, 92.0, 17.0 ],
					"text" : "TONE 2 1000 Hz",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.5, 553.0, 62.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 272.0, 97.0, 92.0, 17.0 ],
					"text" : "TONE 1 1Hz",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 583.0, 88.0, 511.0, 242.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 53.0, 88.0, 528.0, 242.0 ],
					"sonomedcolor" : [ 0.0, 0.749019607843137, 0.498039215686275, 1.0 ],
					"sonomedhicolor" : [ 1.0, 0.749019607843137, 0.0, 1.0 ],
					"sonomedlocolor" : [ 0.498039215686275, 0.0, 0.498039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.5, 79.0, 211.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 51.0, 211.0, 17.0 ],
					"text" : "2 different sinusoids to compare loudness",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.5, 55.0, 92.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 34.0, 171.0, 22.0 ],
					"text" : "loudness 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 960.0, 62.0, 134.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 593.5, 285.0, 73.0, 22.0 ],
					"text" : "cycle~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 285.0, 285.0, 53.0, 22.0 ],
					"text" : "cycle~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 583.0, 332.0, 511.0, 275.0 ],
					"range" : [ -2.0, 2.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 53.0, 332.0, 528.0, 275.0 ],
					"range" : [ -2.0, 2.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1096.0, 88.0, 56.0, 519.0 ],
