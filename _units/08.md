...
{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit8_Reverse-Crash-Cymbal.wav" gain="1.0" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_completion-2.jpg" description="We assume objects to continue when parts of it are hidden behind another object" width="600px" %}

{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit8_perceptualcompletion.wav" gain="1.0" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_Kinazsa_Triangle.png" description="Subjective contour" width="300px" %}
...
-- symmetrical figures are perceived as being grouped together.
 ...
 {% include img-figure url="/MUTOR/assets/images/unit8_symmetry2.png" description="Principle of symmetry" width="400px" %}
## Proximity
...
{% include img-figure url="/MUTOR/assets/images/unit8_goodcontinuation.png" description="Principle of good continuation" width="400px" %}
## Closure
- we tend to see complete figures despite missing parts.
{% include img-figure url="/MUTOR/assets/images/unit8_Gestalt_closure.png" description="Principle of closure" width="400px"%}
## Common fate
...
{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit8_scrambledmelody.wav" gain="1.0" %}
scrambled melody

{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit8_unscrambledmelody.wav" gain="1.0" %}
original melody
...
{% include img-figure url="/MUTOR/assets/images/unit8_ir.png" description="Implication and Realization Intervals" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_I-R_new_1.png" description="Pitch Proximity" width="400px" %}
{% include img-figure url="/MUTOR/assets/images/unit8_I-R_new_2.png" description="Pitch Reversal" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_gap_fill.png" description="An illustration of gap-fill processes." %}
...
{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit8_05-Segregation-Of-A-Melody-From-Interfering-Tones.mp3" gain="1.0" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_hmm.png" description="A Hidden Markov Model used to predict a melodic sequence. (image source: http://www.dlib.org/dlib/february02/birmingham/birmingham-appendix2.html)" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_texture-space.png" description="Texture Space" width="400px"%}
...
{% include img-figure url="/MUTOR/assets/images/unit8_texturespace.jpg" description="Various Musical Genres projected onto Texture Space " %}
