...
{% include img-figure url="/MUTOR/assets/images/unit8_Thatcher-Illusion.png" description="In an face drawn upside-down it is perceptually difficult to tell if  eyes and mouth are right-side up" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_completion-1.jpg" description="" %}
{% include img-figure url="/MUTOR/assets/images/unit8_completion-2.jpg" description="We assume objects to continue when parts of it are hidden behind another object" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_Common-Fate.gif" description="Common Fate" %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_I-R_new.png" description="Quantification of principles of the revised two-factor model of the implication-realization model. Because larger intervals are assigned higher values, negative associations between the principle and expectancy data are presumed." %}
...
{% include img-figure url="/MUTOR/assets/images/unit8_meltrans_patch.png" description="Screenshot of a Max patch implementing a melody transition matrix" %}
