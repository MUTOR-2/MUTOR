...
{% include img-figure url="/MUTOR/assets/images/unit8_ir1.gif" description=" (image source: Krumhansl, 1995) " %}
...
Schellenberg (1997) has shown via principle component analysis that only two principle to sufficiantly describe listeners' expectations:
