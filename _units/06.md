...
{% include img-figure url="/MUTOR/assets/images/tpt-spec-env.png" description="A spectral envelope drawn over the spectrum of a trumpet playing A4 (440 Hz) at <em>mezzo-forte</em>." %}
