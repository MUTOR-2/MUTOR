...
{% include img-figure url="/MUTOR/assets/images/time-vs-freq-domain1.png" description="Time-domain vs frequency-domain representations of a signal." %}
...
{% include note author="jm" text="the examples in this and the previous
section should be interactive--you should be able to listen to the 
examples as well as see the plots" %}
...
{% include note author="jm" text="link to or embed i am sitting in a room" %}
...
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/violin_nofade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/violin_fade.mp3" type="audio/mpeg"></audio>|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/cello_nofade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/cello_fade.mp3" type="audio/mpeg"></audio>|
{:.fade-nofade-table}
