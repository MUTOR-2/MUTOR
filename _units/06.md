...
summary: "In this unit, we will discuss the perceptual phenomenon known as timbre, 
and its relationship to physical characteristics of sound such as the spectrum,
spectral envelope, and attack."
authors: 
 - John MacCallum
...
Many of our most common terms for describing timber, e.g. 
...
into words
{% include cite ref="wallmark_describing_sound" %}.

# Spectrum

As we saw in Unit 1, a *spectrum* represents a complex sound that has been
...
{% include img-figure url="/MUTOR/assets/images/time-domain.png" description="Time-domain representation of a signal." %}
{% include img-figure url="/MUTOR/assets/images/frequency-domain.png" description="Frequency-domain representation of a signal." %}
...
{% include img-figure url="/MUTOR/assets/images/specUncertainty1.png" description="The location of temporal events in a time-domain waveform produces indistinguishable spectra." %}
...
{% include img-figure url="/MUTOR/assets/images/tpt-spec-env.png" description="A spectral envelope drawn over the spectrum of a trumpet playing A4 (440 Hz) at <em>mezzo-forte</em>." width="500px" %}
...
\end{equation}
where $$n$$ is the sample numder, $$N$$ is the number of samples in the 
spectrum, $$f(n)$$ and $$a(n)$$ are the frequency and amplitude of 
bin $$n$$, respectively.

{% include img-figure url="/MUTOR/assets/images/tpt.ff.A4_spec.png" description="The spectrum of a trumpet playing A4 (440 Hz) <em>fortissimo</em>. The red line shows the spectral centroid. Compare with the figure below to see how it moves when the same note is played quieter." width="500px" %}
{% assign fig-tpt-ff = fignum %}
<audio controls><source src="/MUTOR/assets/audios/tpt.ff.A4.mp3" type="audio/mpeg"></audio>
{% include img-figure url="/MUTOR/assets/images/tpt.pp.A4_spec.png" description="The spectrum of a trumpet playing A4 (440 Hz) <em>pianissimo</em>. The red line shows the spectral centroid. Compare with the figure above to see how it moves when the same note is played louder." width="500px" %}
{% assign fig-tpt-pp = fignum %}
<audio controls><source src="/MUTOR/assets/audios/tpt.pp.A4.mp3" type="audio/mpeg"></audio>
...
{% include img-figure url="/MUTOR/assets/images/formants-benade.png" description="The formant structure of three different vowel sounds." width="300px" %}
...
{% include img-figure url="/MUTOR/assets/images/cello_clar_C4.png" description="The spectra of a cello (red) and a clarinet (blue) each playing C4 (middle C). Note that the even partials of the clarinet have almost no energy." width="500px" %}
...
{% include img-figure url="/MUTOR/assets/images/adsr.png" description="The temporal envelope of a sound, showing a common segmentation into four parts: Attack, Decay, Sustain, and Release (ADSR)." %}
...
|---|---|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/trumpet_fade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/trumpet_nofade.mp3" type="audio/mpeg"></audio>|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/bassoon_fade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/bassoon_nofade.mp3" type="audio/mpeg"></audio>|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/oboe_fade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/oboe_nofade.mp3" type="audio/mpeg"></audio>|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/synth.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/synth.mp3" type="audio/mpeg"></audio>|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/altosax_fade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/altosax_nofade.mp3" type="audio/mpeg"></audio>|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/violin_fade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/violin_nofade.mp3" type="audio/mpeg"></audio>|
|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/cello_fade.mp3" type="audio/mpeg"></audio>|<audio controls><source src="/MUTOR/assets/audios/fade_nofade/cello_nofade.mp3" type="audio/mpeg"></audio>|
{:.fade-nofade-table}
...
{% include img-figure url="/MUTOR/assets/images/BbClar-attack.mf.A4.png" description="The attack of a Bb clarinet playing A4 (440 Hz) <em>mezzo-forte</em>. Note the staggered entry of the partials." %}
...
{% include audio-buffer name="mybuf" src="/MUTOR/assets/audios/sather-0.7.bell.mn.mp3" %}
...
{% include img-figure url="/MUTOR/assets/images/Cellos_G2B2.png" description="Spectra of two cellos playing G2 and B2." width="500px" %}
{% assign cellos_thirds = fignum %}
<audio controls>
<source src="/MUTOR/assets/audios/cello.mf.G2-B2.mp3" type="audio/mpeg">
</audio>
{% include img-figure url="/MUTOR/assets/images/Bassoons_G2B2.png" description="Spectra of twy bassoons playing G2 and B2, the same interval as above. Note the tightly spaced partials pointed to by the arrows." width="500px" %}
{% assign bassoons_thirds = fignum %}
<audio controls>
<source src="/MUTOR/assets/audios/Bassoon.mf.G2-B2.mp3" type="audio/mpeg">
</audio>
...
{% include img-figure url="/MUTOR/assets/images/farbenex_orch.png" description="The two orchestrations of the opening chord of Schoenberg's <em>Farben</em>." width="400px" %}
<audio controls>
<source src="/MUTOR/assets/audios/farben-orch1.mp3" type="audio/mpeg">
</audio>
<audio controls>
<source src="/MUTOR/assets/audios/farben-orch2.mp3" type="audio/mpeg">
</audio>
The title of this 
...
<audio controls>
<source src="/MUTOR/assets/audios/farben-sin.mp3" type="audio/mpeg">
</audio>
The notes of the
...
{% include img-figure url="/MUTOR/assets/images/farbenorchestration.GIF" description="An analysis of the spectra of the two orchestrations of the 'Farben' chord, in comparison with a rendering of pure sinusoids." %}
...
{% include cite ref="wessel_timbre_space" %}, that,
...
{% include img-figure url="/MUTOR/assets/images/wessel-illusion.png" description="Wessel Illusion: the black noteheads represent one timbre, and the white, another." %}

As the tempo increases, gradually the two timbres "split apart" into 
their own descending melodies, as shown below.

{% include img-figure url="/MUTOR/assets/images/wessel-illusion-split.png" description="Wessel Illusion: as the tempo increases, the percept switches from a single repeated ascending line, to two descinding lines." %}

{% include mov-figure src="/MUTOR/assets/videos/unit6_wessel illusion.mp4" type="mp4" description="Maxpatch example: David Wessel's Illusion." width="600px" %}
