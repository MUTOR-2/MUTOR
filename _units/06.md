...
{% include img-figure url="/MUTOR/assets/images/tpt.ff.A4_spec.png" description="The spectrum of a trumpet playing A4 (440 Hz) <em>fortissimo</em>. The red line shows the spectral centroid. Compare with the figure below to see how it moves when the same note is played quieter." %}
{% assign fig-tpt-ff = fignum %}
<audio controls><source src="/MUTOR/assets/audios/tpt.ff.A4.mp3" type="audio/mpeg"></audio>
{% include img-figure url="/MUTOR/assets/images/tpt.pp.A4_spec.png" description="The spectrum of a trumpet playing A4 (440 Hz) <em>pianissimo</em>. The red line shows the spectral centroid. Compare with the figure above to see how it moves when the same note is played louder." %}
...
{% include img-figure url="/MUTOR/assets/images/formants-benade.png" description="The formant structure of three different vowel sounds." %}
...
{% include img-figure url="/MUTOR/assets/images/cello_clar_C4.png" description="The spectra of a cello (red) and a clarinet (blue) each playing C4 (middle C). Note that the even partials of the clarinet have almost no energy." %}
...
{% include img-figure url="/MUTOR/assets/images/Cellos_G2B2.png" description="Spectra of two cellos playing G2 and B2." %}
{% assign cellos_thirds = fignum %}
<audio controls>
<source src="/MUTOR/assets/audios/cello.mf.G2-B2.mp3" type="audio/mpeg">
</audio>
{% include img-figure url="/MUTOR/assets/images/Bassoons_G2B2.png" description="Spectra of twy bassoons playing G2 and B2, the same interval as above. Note the tightly spaced partials pointed to by the arrows." %}
...
{% include img-figure url="/MUTOR/assets/images/farbenex_orch.png" description="The two orchestrations of the opening chord of Schoenberg's <em>Farben</em>." %}
<audio controls>
