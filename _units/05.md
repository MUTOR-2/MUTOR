...
\begin{equation}
I=1200\cdot log_2(\frac{F_1}{F_0}) = 1200\cdot log_{10}\frac{(\frac{F_1}{F_0})}{log_{10}(2)}
...
| Interval (Name) | Frequency ratio (?) {% comment %} Frequenzverhältnis {% endcomment %}| Interval (Size in Cents) | Size of Tempered Interval
| unison | 1/1 | 0 | 0 |
