...
{% include img-figure url="/MUTOR/assets/images/unit5_chromatorus.png" description="Double Helix winding a torus" %}
...
The Neo-Riemannian _tonnetz_ has also been successfully projected onto the surface of a torus.

{% include img-figure url="/MUTOR/assets/images/unit5_tonnetz-torus.jpg" description="Neo-Riemannian tonnetz" %}
