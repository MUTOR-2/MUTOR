...
which we will continue to encounter throughout these units.
...
without controversy and has been "severly critiqued" from a number of angles.
...
{% include note author="jm"
text="need a number of examples here to play with tones moving in
and out of the critical band, with and without harmonics. in the original
materials, there was a critical band demo, and a demo presenting the
tritone as both consonant and dissonant." %}
...
{% include note author="jm" text="include audio examples here." %}
...
{% include note author="jm" text="i need to review KK's work to say something about it..." %}.
...
{% include note author="jm" text="probe tone here as well? the original tiddlywiki says that it is covered in another unit" %}
...
the listener from hearing dissonant intervals as such. Figure 1 is an example 
