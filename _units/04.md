...
summary: "In this unit we discuss consonance and dissonance, and the 
important role they play in music. We will begin with some of the earliest
observations and attempts to model them, and proceed through more modern 
understandings of sensory dissonance and its associated physiology."
authors: 
 - John MacCallum
 - Psyche Loui
...
test_questions:
 ...
 - Which of the following sounds most dissonant?
   a) C4 and B4 played on pure tones
   b) C4 and B4 played on two clarinets on the opposite sides of a stage
   c) C4 and B4 played on two trumpets on the same side of a stage
   d) C4 and E4 played on two clarinets on the same side of a stage
...
The next clue can be found by looking at the treatement of the fourth,
...
inner or upper voices is considered consonant and needs no special treatement.
{% include note author="jm" text="need an audio example of these chords" %}
{% include img-figure url="/MUTOR/assets/images/fourths.png" 
description="In common practice tonality, a fourth between the bottom voices 
is dissonant, while one in the inner voices is consonant." %}
...
{% include img-figure url="/MUTOR/assets/images/bekesy.png"
...
\end{equation}
{% include img-figure url="/MUTOR/assets/images/gammatonefilters.GIF"
...
{% include img-figure url="/MUTOR/assets/images/ERB-plot.png"
description="The size of the critical band as it varies with frequency." %}

{% include img-figure url="/MUTOR/assets/images/ERB-octaves.png"
...
{% include img-figure url="/MUTOR/assets/images/MUTOR_CriticalBand.png" description="" %}
...
{% include img-figure url="/MUTOR/assets/images/farbenex.png"
description="Roughness estimates for three orchestrations of the same
harmony from Arnold Schoenberg's Farben, Op. 16." %}

{% include begin-figure description="Farben, first orchestration" %}
<audio controls>
<source src="/MUTOR/assets/audios/farben-orch1.mp3" type="audio/mpeg">
</audio>
{% include end-figure %}
{% include begin-figure description="Farben, second orchestration" %}
<audio controls>
<source src="/MUTOR/assets/audios/farben-orch2.mp3" type="audio/mpeg">
</audio>
{% include end-figure %}
{% include begin-figure description="Farben, sine tones" %}
<audio controls>
...
{% include img-figure url="/MUTOR/assets/images/farbenorchestration.GIF"
description="Spectral analysis of three orchestratiosn of the 'Farben'
chord." %}
...
{% include begin-figure description="Ligeti, Atmosph&egrave;res." %}
<audio controls>
<source src="/MUTOR/assets/audios/atmospheres.mp3" type="audio/mpeg">
</audio>
{% include end-figure %}
...
{% include img-figure url="/MUTOR/assets/images/cluster-v-440-466.png"
description="Top: Sum of two sinusoids at 440 Hz and 466.1638 Hz
(minor second). Middle-top: Sum of 40 sinusoids at random frequencies
between 440 Hz and 466.1638 Hz, with random phases. Middle Bottom:
Closeup of the top plot. Bottom: Closeup of the middle-top plot." %}
...
{% include end-figure %}
{% include begin-figure description="Two sine tones: 440 Hz and 466.1638 Hz (minor second)." %}
<audio controls>
<source src="/MUTOR/assets/audios/m2.mp3" type="audio/mpeg">
</audio>
{% include end-figure %}
{% include begin-figure description="40 sine tones at random frequencies and phases between 440 Hz and 466.1638 Hz (minor second)." %}
<audio controls>
<source src="/MUTOR/assets/audios/cluster.mp3" type="audio/mpeg">
</audio>
{% include end-figure %}
...
description="Interval hierarchy (Kameoka and Kuriyagawa)" %}
...
{% include img-figure url="/MUTOR/assets/images/bregman-wright_20hypoth1.png"
...
{% include img-figure url="/MUTOR/assets/images/icfiring.GIF"
