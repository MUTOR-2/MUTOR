...
{% include img-figure url="/MUTOR/assets/images/minor_second_pair.png"
description="Sum of two sinusoids at 440 Hz and 466.1638 Hz
(minor second). " %}
{% assign myfigref = fig_minor_second_pair %}

{% include img-figure url="/MUTOR/assets/images/minor_second_cluster.png"
description="Sum of 40 sinusoids at random frequencies
between 440 Hz and 466.1638 Hz, with random phases." %}

{% include img-figure url="/MUTOR/assets/images/minor_second_pair_closeup.png"
description="Closeup of two sinusoids at 440 Hz and 466.1638 Hz." %}

{% include img-figure url="/MUTOR/assets/images/minor_second_cluster_closeup.png"
