...
summary: A scale is a set of pitches ordered according to various principles of historical importance. They provide the pitch material chords are built from. The theory of harmony is preoccupied with the laws governing the structure, relation, and progression of chords, much of it based on the principle of tension and release. In recent times, composers and theorists have also started to consider elements such as roughness and inharmonicity when constructing sonorities and their progressions.
authors: 
 - Georg Hajdu
 - John MacCallum
...
Via enharmonic equivalence, equal temperament adds another dimension to modulation as there is no *audible* distinction between the dominant seventh chord (C-E-G-Bb; a dominant in the key of F) and the German 6th chord (C-E-G-A#, a secondary dominant in the key of E). This ambiguity has been exploited by composers in the Classical and Romantic periods to quickly modulate to distant key areas. 
As the dissonant Bb is resolved by downward motion (inwards) while the leading tone A# moves up (outwards),  this type of pivoting is comparable to the ambiguous cube illusion (a type of a Necker cube) where a cube can either be perceived as projecting inwards or outwards. 
