...
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit9_Tristan_Chord.wav" gain="1.0" %}
...
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit9_froberger-capriccioInCmaj.mp3" gain="1.0" %}
...
{% include img-figure url="/MUTOR/assets/images/unit9-Archicembalo_en_Cents.png" description="The Archicembalo had a large number of tuning alternatives for the 12 keys of the chromatic scale." %}
...
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit9_Der_Neugierige.wav" gain="1.0" %}
...
{% include img-figure url="/MUTOR/assets/images/unit9_clarinets.png" description="Bohlen-Pierce clarinets in three sizes" width="300px" %}
...
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit9_Scriabin_Hajdu_ Burnig Petrol.mp3" gain="1.0" %}

Burning Petrol, an arrangement of the piano poem Vers la flamme by Alexander Scriabin for Bohlen-Pierce ensemble.
...
{% include img-figure url="/MUTOR/assets/images/unit9_Gamelan_Dissonance_Curve.png" description="Dissonance Curve for the pelog scale" width="400px" %}

{% include img-figure url="/MUTOR/assets/images/unit9_Gamelan-Orchestra.jpg" description="A Gamelan orchestra" %}
(Image source: https://commons.wikimedia.org/wiki/File:Indra_Swara_gamelan.jpg)
