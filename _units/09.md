...
# Period Tunings
A tuning where all thirds and fifths are just cannot exist mathematically, therefore all tunings such as the following are compromises. The term _temperament_ (as opposed to _tuning_) refers to the attempt of creating a compromise by either modifying thirds and/or fifths.
