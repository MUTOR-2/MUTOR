...
[Webster's dictionary](http://www.m-w.com) defines harmony in reference to music as (1) _the combination of simultaneous musical notes in a chord, (2) the structure of music with respect to the composition and progression of chords or (3) the science of the structure, relation, and progression of chords._ Colloquially, harmony also denotes _the pleasing or congruent arrangement of parts_.
...
A number of variants have been in use, quarter-comma and third-comma meantone temperament among them. The term quarter-comma, for instance, emphasizes the fact in this temperament the just fifth (702 cents) is lowered by an interval corresponding to a fourth of Syntonic comma (21.5 cents / 4 = 5.375 cents): 696.6 cents. Other temperaments have been suggested by Werckmeister, Valotti and others all geared towards allowing modulation to distant key areas while keeping thirds and fifth as pure as possible.

Many of these tunings and temperaments lead to tuning alternatives for any given key. For instance, in just intonation an Ab (8/5; going down by a just major third) is different from a G# (25/16; stacking two just major thirds). Keyboards such as the archicembalo built in 1588 have therefore been constructed to represent tuning alternatives. 
...
The ultimate compromise has been achieved by introducing 12-tone equal temperament - the tuning of choice in the Classical, Romantic and Modern periods. Here, the discrepancy between 12 fifts and 7 octaves (Pythagorian comma; 23.46 cents) is _tempered out_ by dividing up the comma evenly (1.96 cents) and applying this value to all fifths: 701.96 cents - 1.96 cents = 700 cents. 
...
We have already mentioned that the role of a chord depends on its context. Changing this role facilitates modulation such as when the tonic triad of C major is being reinterpreted as the subdominant of G major - C major serving as a _pivot_ chord between those two key areas.
...
In turn, 19TET (approximation of 1/3 comma meantone tuning) and 31TET (approximation of 1/4 comma meantone tuning) features excellent major thirds and have therefore even been considered by 20th century scholars such as Joseph Yasser and Adriaan Fokker as contenders for the replacement of 12TET. 
...
Many tunings such as at 17TET, 19TET, 22TET, 31TET, 41TET and 53TET also features a __diatonic__ sub set of pitches and therefore be used as alternative tunings for tonal music.  
...
a candence played with those sounds also asks for the scale to be stretched by the same amount. Otherwise, the chords and their progression sound out of tune. This is due to the lining up of the partials when playing sound simultaneously and sequentially. 
...
1. Both spectra and scale are stretched: the chords and their progression sound convincing. 
...
# Harmony and Timing
In Western tonal music, chord progressions follow certain _syntactic_ rules particularly in cadences and sequences. Thereby, the meaning of a chord depends on its position on a weak or strong beat. Consider the sonority G-C-E-G commonly referred to as a **second inversion 6-4 chord**. If positioned on the downbeat of measure, it is perceived as **cadential 6-4 chord**, first resolving to the dominant and then finally to the tonic. If positioned on a weak beat between a subdominant and its first inversion it is to be labeled as a **passing 6-4 chord** with no need to resolve any of its pitches.  

# Harmony and Gestalt
Intervals and chords are commonly derived from the harmonic series. The major triad has throughout history been explained as representative of the 4/5/6 relationship. The derivation of minor chord, in turn, has been more controversial. Some consider it the representation of the 10/12/15 relationship while other argue that it actually stems from subharmonic series, the inversion of the harmonic series (with the same relationship of the ordinal numbers 4/5/6 as the major chord). While chords taken from the subharmonic series may still be considered stable, they may lack a fundamental quality related to the creation of a virtual fundamental.

Chords, therefore, need to be regarded as hierarchical gestalts of gestalts where aspects such as virtual fundamental, voicing, sensory dissonance and temporal succession (context) come into play.
