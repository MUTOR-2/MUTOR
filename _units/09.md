...
Many of these tunings and temperaments lead to tuning alternatives for any given key. For instance, in just intonation an Ab (8/5) is different from a G# (25/16). Keyboards have been built to represent those alternatives such as the archicembalo from 1588. 
