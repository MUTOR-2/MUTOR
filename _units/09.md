...
# Harmony and Gestalt
Intervals and chords are commonly derived from the harmonic series. The major triad has throughout history been explained as representative of the 4/5/6 relationship. The derivation of minor chord, in turn, has been more controversial. Some consider it the representation of the 10/12/15 relationship while other argue that it actually stems from the subharmonic series, the inversion of the harmonic series - with the same relationship of the ordinal numbers 4/5/6 as the major chord. While chords taken from the subharmonic series may still be considered stable, they often lack a fundamental quality related to the perception of a virtual fundamental and, therefore, sound less resonant.
