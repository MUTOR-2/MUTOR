...
{% include img-figure url="unit3_db_amp_formula.png" description="decibel formula amplitude" %}
...
{% include img-figure url="unit3_loudness1-screenshot.png" description="loudness1 demo" %}
...
{% include img-figure url="unit3_Fletcher-Munson.gif" description="fm curve" %}
...
{% include img-figure url="unit3_fm-curve.png" description="fm curve2" %}
...
{% include img-figure url="unit3_stephens_plaw_formula.png" description="stephens power law" %}
...
{% include img-figure url="unit3_loudness2-screenshot.png" description="loudness2" %}
...
{% include img-figure url="unit3_loudness3-screenshot.png" description="loudness3" %}
...
{% include img-figure url="unit3_tuba-cresc.png" description="tuba spectrum cresc" %}
Figure 3: A tuba playing A3 going from moderately loud to soft to loud.
 
![Tuba Crescendo](tuba-cresc.aif?controlsList=nodownload-nofullscreen-noremoteplayback)
...
{% include img-figure url="unit3_loudness4-screenshot.png" description="loudness4" %}
...
![Example 1](unit3_larry1.wav?controlsList=nodownload-nofullscreen-noremoteplayback)
![Example 2](unit3_Psycho1.wav?controlsList=nodownload-nofullscreen-noremoteplayback)
