...
{% include img-figure url="/MUTOR/assets/images/unit3_sdt1.png" description="Signal Detection Theory illustration" width="300px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_sdt2.png" description="SDT Criterion" width="300px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_sdt3.png" description="d prime illustration" width="400px" %}
...
{% include p/xsonogram src="/MUTOR/assets/audios/unit3_tuba-cresc.wav" %}
{% include end-figure %}
...
<html>
  ...
  <body>
    <audio controls src="/MUTOR/assets/audios/unit3_tuba-cresc.wav">
...
{% include p/xwaveform-scope src="/MUTOR/assets/audios/noisebursts.wav" %}
{% include end-figure %}
...
{% include p/xwaveform-scope src="/MUTOR/assets/audios/sinebursts.wav" %}
{% include end-figure %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_reverb-direct-plot.png" description="The direct sound from figure 3.13." width="450px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_reverb-direct-early-plot.png" description="The early reflections from figure 4 plotted against time." width="450px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_reverb-plot.png" description="The reverb in a room tends to decay exponentially." width="450px" %}
...
{% include p/xsonogram src="/MUTOR/assets/audios/unit3_impulse1.wav" %}
{% include end-figure %}

{% include begin-figure description="The reverb decays of three different rooms: response 2." %}
{% include p/xsonogram src="/MUTOR/assets/audios/unit3_impulse2.wav" %}
{% include end-figure %}

{% include begin-figure description="The reverb decays of three different rooms: response 3." %}
{% include p/xsonogram src="/MUTOR/assets/audios/unit3_impulse3.wav" %}
{% include end-figure %}

{% comment %}
{% include img-figure url="/MUTOR/assets/images/unit3_impulse-specgram-decayenv.png" description="The reverb decays of three different rooms: response 1." width="300px" %}

<audio controls src="/MUTOR/assets/audios/unit3_impulse1.wav">
Your browser does not support the audio element.
</audio>

{% include img-figure url="/MUTOR/assets/images/unit3_impulse2-specgram-decayenv.png" description="The reverb decays of three different rooms: response 2." width="300px" %}
<audio controls src="/MUTOR/assets/audios/unit3_impulse2.wav">
Your browser does not support the audio element.
</audio>

 {% include img-figure url="/MUTOR/assets/images/unit3_impulse3-specgram-decayenv.png" description="The reverb decays of three different rooms: response 3." width="300px" %}
...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=yaloAI3CEFg" 
...
{% include img-figure url="/MUTOR/assets/images/unit3_happybday.png" description="happy birthday" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_franssen.gif" description="Franssen Effect" width="450px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_boltz.png" description="Boltz soundtrack study" %}
