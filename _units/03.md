...
{% include img-figure url="/MUTOR/assets/images/unit3_impulse-specgram-decayenv.png" description="The reverb decays of three different rooms: response 1." width="150px" %}

<audio controls src="/MUTOR/assets/audios/unit3_impulse1.wav">
Your browser does not support the audio element.
</audio>

{% include img-figure url="/MUTOR/assets/images/unit3_impulse2-specgram-decayenv.png" description="The reverb decays of three different rooms: response 2." width="150px" %}
<audio controls src="/MUTOR/assets/audios/unit3_impulse2.wav">
Your browser does not support the audio element.
</audio>

 {% include img-figure url="/MUTOR/assets/images/unit3_impulse3-specgram-decayenv.png" description="The reverb decays of three different rooms: response 3." width="150px" %}
