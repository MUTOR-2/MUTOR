...
{% include img-figure url="/MUTOR/assets/images/unit3_lakescene.png" description="Lake Scene" %}
...
<html>
  ...
  <body>
    <audio controls src="/MUTOR/assets/audios/unit3_Psycho1.wav">
      Your browser does not support the audio element.
    </audio>
  </body>
</html>
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-nosound.png" description="A listener in a room in which a loud short sound is made." %}

{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-direct.png" description="The first sound to hit the listener is called the direct sound." %}

{% include img-figure url="/MUTOR/assets/images/unit3_reverb-direct-plot.png" description="The direct sound from figure 2." %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-1stRef.png" description="The early reflections arrive at the listener after a short delay and with some loss of energy." %}

{% include img-figure url="/MUTOR/assets/images/unit3_reverb-direct-early-plot.png" description="The early reflections from figure 4 plotted against time." %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-reverb.png" description="Reverb is as the original sound continues to bounce around the room, we perceive reverb." %}

{% include img-figure url="/MUTOR/assets/images/unit3_reverb-plot.png" description="The reverb in a room tends to decay exponentially." %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_inverse-square-diagram.png" description="Sound propagating away from a source diffuses over a larger and larger area." %}
...
Sound examples 1-3, and figures 3.20 - 3.22 are impulse responses of three different halls and their sonograms. Notice that the reverb of each hall decays in a different way and that different frequency regions decay quicker than others but that in general the low frequencies remain active longer than the high frequencies—this is a typical property of the reverb of most enclosed spaces. Also, note that the early reflections can be heard clearly in the second and third examples.

{% include img-figure url="/MUTOR/assets/images/unit3_impulse-specgram-decayenv.png" description="The reverb decays of three different rooms: response 1." %}

    <audio controls src="/MUTOR/assets/audios/unit3_impulse1.wav">
      Your browser does not support the audio element.
    </audio>
    
{% include img-figure url="/MUTOR/assets/images/unit3_impulse2-specgram-decayenv.png" description="The reverb decays of three different rooms: response 2." %}

    <audio controls src="/MUTOR/assets/audios/unit3_impulse2.wav">
      Your browser does not support the audio element.
    </audio>
    
 {% include img-figure url="/MUTOR/assets/images/unit3_impulse3-specgram-decayenv.png" description="The reverb decays of three different rooms: response 3." %}
 
   <audio controls src="/MUTOR/assets/audios/unit3_impulse3.wav">
      Your browser does not support the audio element.
    </audio>
...
<html>
  ...
  <body>
    <audio controls src="/MUTOR/assets/audios/unit3_Frere_Jacques.mp3">
      Your browser does not support the audio element.
    </audio>
  </body>
</html>

The opening measures of Mahler's Symphony No. 1 in D, "Titan".
<html>
  <head>
    <title>Larry</title>
  </head>
  <body>
    <audio controls src="/MUTOR/assets/audios/unit3_mahler1.mp3">
      Your browser does not support the audio element.
    </audio>
  </body>
</html>
...
{% include img-figure url="/MUTOR/assets/images/unit3_topdownillusion.jpg" description="Top Down." %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_topdownillusion2.jpg" description="Perceptual illusion corrected" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_happybday.jpg" description="happy birthday" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_franssen.gif" description="Franssen Effect" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_clifton.gif" description="Clifton Effect" %}
(image source: http://www.parmly.luc.edu/parmly/clifton.html)
...
<html>
  ...
  <body>
    <audio controls src="/MUTOR/assets/audios/unit3_clifton.wav">
      Your browser does not support the audio element.
    </audio>
  </body>
</html>
...
{% include img-figure url="/MUTOR/assets/images/unit3_boltz.jpg" description="Boltz soundtrack study" %}
...
<html>
  ...
  <body>
    <video controls src="/MUTOR/assets/videos/unit3_babyvent.mpg">
      Your browser does not support the audio element.
    </video>
  </body>
</html>
...
<html>
  ...
  <body>
    <video controls src="/MUTOR/assets/videos/unit3_McGurk_large.mp4">
