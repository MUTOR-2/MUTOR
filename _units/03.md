...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=BoYgMVUmZPY" 
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-nosound.png" description="A listener in a room in which a loud short sound is made." width="650px" %}

{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-direct.png" description="The first sound to hit the listener is called the direct sound." width="650px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-1stRef.png" description="The early reflections arrive at the listener after a short delay and with some loss of energy." width="650px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-reverb.png" description="Reverb is as the original sound continues to bounce around the room, we perceive reverb." width="650px" %}
...
{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit3_Frere_Jacques.mp3" gain="1.0" %}


The opening measures of Mahler's Symphony No. 1 in D, "Titan", 3rd movement.

{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit3_mahler1.mp3" gain="1.0" %}
...
{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/unit3_clifton.wav" gain="1.0" %}
