...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-nosound.png" description="A listener in a room in which a loud short sound is made." width="450px" %}

{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-direct.png" description="The first sound to hit the listener is called the direct sound." width="450px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-1stRef.png" description="The early reflections arrive at the listener after a short delay and with some loss of energy." width="450px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit3_roomAcoustics-reverb.png" description="Reverb is as the original sound continues to bounce around the room, we perceive reverb." width="450px" %}
