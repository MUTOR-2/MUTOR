...
Signal Detection Theory illustration 
...
SDT Criterion (image source: http://www.cns.nyu.edu/~david/sdt/sdt.html)
Criterion adoption (i.e. how liberal you are at labelling a trial as "signal") does not affect sensitivity as measured by d'.

d prime illustration (image source: http://www.cns.nyu.edu/~david/sdt/sdt.html)
