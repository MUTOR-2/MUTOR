...
{% include mov-figure src="/MUTOR/assets/videos/unit2_musicinotherspecies.mp4" type="mp4" description="Example maxpatch: spectrum and sonogram to visualise audio spectrum of other species." width="600px" %}
