...
summary: In this unit we will explain how does it works the biological process of hearing. We will cover the structure and function of the auditory system focusing on the elements that allow us to conceivd hearing as an actively perceiving process, more than just a passive response to a phisical stimulus. We will also compare our musical system with other species. and try to understand when and why the auditory system malfunctions and how to protect our own hearing. # The biological basis of hearing 

authors: 
 - Psyche Loui
topics: [Auditory Pathway, Structures and functions, Acticve Ear, Evolution of the Auditory System, Music in other Species, Hearing Damage]
test_questions:
 ...
 - 1. Which of the following is most heavily implicated in being able to perceive location of sound sources?
    inferior colliculus
    cochlea
...
The anatomy section of this unit will cover the peripheral and central auditory nervous sysstems, from the outer ear
...
brain and the spinal cord, and parts of the central nervous system involved in auditory function are in the brainstem, the midbrain, and the cerebral cortex. Afferent pathways include all neural pathways going from the auditory periphery to the cerebral cortex, whereas efferent pathways are all pathways coming from the cortex back to the periphery. Both pathways will be discussed in the present unit. Emphasis will be placed on the function as well as structure of each region along the auditory pathway.

{% include img-figure url="/MUTOR/assets/images/aud_anatomy_overview.jpg" description="The Auditory Pathway" %}

# Structure vs Function

{% include note author="vg" text="I have commented all the descriptions and sources of the pictures on this Unit waiting for us to decide the way we will present this information. Everything is on the 02.md file so don't worrie is some information is missing!" %}
{% comment %} An overview of the auditory periphery. {% endcomment %}
{% include img-figure url="/MUTOR/assets/images/ear_overview.png" description="Overview of the Auditory Periphery: The Ear" %}
{% comment %} (image source: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/ear.html) {% endcomment %}

A detailed look at each anatomical region of the auditory system must include both the structure and the function of each region. Many regions along the auditory pathway serve specific functions, and some aspects of their structure have evolved especially to optimize these functions. Two of the main auditory function we will discuss are TonotopicMapping and BinauralHearing. While both are important functions of the auditory system as a whole, specialized mechanisms are built into the Cochlea and the SuperiorOlive to enable TonotopicMapping and BinauralHearing respectively. we will see how the structure of each part of the anatomy is optimized to perform its function.

# The Ear

"The ear", for our purposes, is not just what sticks out on each side of your head. Although the visible part of the ear, also known as the pinna, constitutes the outer ear and plays an important role in hearing, TheEar also includes the middle, and inner ear, each of which has structures specialized for their functions. The middle ear has a series of ossicles, or tiny bones which conduct and amplify the sound signal. The inner ear is of vital importance to hearing as it includes the Cochlea, perhaps the most important structure in the auditory periphery, which transduces sound signals into nerve impulses.
...
{% include img-figure url="/MUTOR/assets/images/cochlea_dissected.png" description="Cochlea Dissected" %}
...
These membranes together divide the cochlea into its fluid-filled chambers: scala vestibuli, scala tympani, and scala media. Importantly, the middle section section contains the Organ of Corti, which includes the basilar membrane, the tectorial membrane, and the hair cells between these two membranes.
...
{% include img-figure url="/MUTOR/assets/images/a1_a2.jpg" description="Auditory Cortex" %}
...
Famous people suffering from hearing loss (adapted from http://www.hearnet.com/):
                                                        {% comment %} HOW TO MAKE THIS A REAL LINK? {% endcomment %}
...
Lars Ulrich from Metallica advocates protecting your hearing.

(video source: http://www.hearnet.com/index.shtml) AvoidingLoudSounds
            {% comment %} REAL LINK! {% endcomment %}
{% include note author="vg" text="Here you want to include one of your videos Psyche? Or you just want a link to the source?" %}
