...
{% include img-figure url="/MUTOR/assets/images/cochlea_dissected.png" description="Cochlea Dissected" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/ihc_ohc.png" description="Inner and Outer Hair Cells" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/tonotopy.png" description="Tonotopy Basilar Membrane" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/bekesy.png" description="Data on Tonotopy from von Békésy " width="auto" height="500px" %}
...
{% include img-figure url="/MUTOR/assets/images/brainstem_diagram.png" description="Brainstem Diagram" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/cn8.png" description="Cranial Nerve VIII (auditory nerve in red)" width="500px" %}
...
{% include img-figure url="/MUTOR/assets/images/itd.jpg" description="Interaural Time Difference" width="500px" %}
{% include img-figure url="/MUTOR/assets/images/ild.jpg" description="Interaural Level Difference" width="500px" %}
...
{% include img-figure url="/MUTOR/assets/images/mso_coincidence1.jpg" description="A. Model of Coincidence Cetection" width="400px" %}
{% comment %} (image source: http://www.physiology.wisc.edu A. Jeffress's (1948) model of coincidence detection. {% endcomment %}

{% include img-figure url="/MUTOR/assets/images/mso_coincidence2.jpg" description="B. Physiological Implementation of Coincidence Detection" width="300px" %}
...
{% include img-figure url="/MUTOR/assets/images/ttremolo.png" description="Tremolo" width="300px" %}
...
{% include img-figure url="/MUTOR/assets/images/audctx1-2.png" description="The Sylvian fissure, with the Auditory Cortex below it." width="500px" %}
...
{% include mov-figure src="/MUTOR/assets/videos/unit2_musicinotherspecies.mp4" type="mp4" description="Maxpatch example: spectrum and sonogram to visualise audio spectrum of other species." width="600px" %}

_you can have access to all MUTOR maxpatches when you download the [MUTOR github repository](https://github.com/MUTOR-2/MUTOR) inside the maxpatches folder._

{% comment %}
{% include img-figure url="/MUTOR/assets/images/animal_song.jpg" description="Animal Songs" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/earmuffs.jpg" description="Ear Muffs" width="200px" %}
{% include img-figure url="/MUTOR/assets/images/earplugs.jpg" description="Ear Plugs" width="200px" %}
...
{% include img-figure url="/MUTOR/assets/images/protection_attenuation.gif" description="Protection Attenuation" width="500px" %}
