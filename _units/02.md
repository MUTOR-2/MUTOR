...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=_CqDEiHh79Q" 
...
(Adapted from: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/ear.html)
...
(Adapted from: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/eari.html)
...
(Image source: Mireille Lavigne Rebillard, from http://www.cochlea.eu/en/ear/inner-ear EDU website "Journey into the World of Hearing", by Rémy Pujol et al., NeurOreille, Montpellier)
...
(Upper part adapted from: https://wellcomecollection.org/works/jfsbzy4g)
...
(Adapted from: https://wellcomecollection.org/works/sr3ru95y)
...
{% include p/xwaveform-spectroscope-small src="/MUTOR/assets/audios/audiogram.mp3" gain="1.0" %}
...
(image source:http://www.sfu.ca/sonic-studio/handbook/Audiogram.html)
...
(image source: http://www.hei.org/education/health/loss.htm)
{% comment %}  Normal versus damaged hair cells {% endcomment %}
