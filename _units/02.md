...
Demo Normal Hearing vs. High-Frequency Hearing loss (Source: `[Handbook for Acoustic Ecology (Barry Truax, 1999)](https://www.sfu.ca/sonic-studio-webdav/handbook/Audiogram.html)`)
...
{% include img-figure url="/MUTOR/assets/images/audiogram.jpg" description="Audiogram comparason: Normal Hearing Imparment due to Loud Noise" %}
...
{% include img-figure url="/MUTOR/assets/images/audiogram_presby.jpg" description="Audiogram Presbyacusis or Ski-Slope Hearing" %}
...
{% include img-figure url="/MUTOR/assets/images/normalvsdamaged.jpg" description="Comparison Normal Hair Cell vs. Damaged Hair Cell" %}
{% comment %} (image source: http://www.hei.org/education/health/loss.htm) Normal versus damaged hair cells {% endcomment %}

{% include img-figure url="/MUTOR/assets/images/audiogram_presby.jpg" description="Presbyacusis Audiogram" %}
