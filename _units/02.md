...
{% comment %} (image by Mireille Lavigne Rebillard, from http://www.cochlea.eu/en/ear/inner-ear EDU website "Journey into the World of Hearing", by Rémy Pujol et al., NeurOreille, Montpellier) {% endcomment%}
...
{% comment %} Close-up of inner hair cells with stereocilia, which open when excited by incoming sound. (image source: https://wellcomecollection.org/works/jfsbzy4g){% endcomment%}
...
{% comment %} (Adapted from Watts, 1993) Schematic of the rolled-up basilar membrane, with its optimally sensitive frequencies marked along its length. {% endcomment %}
...
{% comment %} (Adapted from image: http://www.pbrc.hawaii.edu/bekesy/ taken from Nobel Lectures Physiology or Medicine 1942 - 1962, Elsevier, 1964, pp. 722-746) {% endcomment %}
...
{% include mov-figure src="/MUTOR/assets/videos/unit2_musicinotherspecies.mp4" type="mp4" description="Maxpatch example: spectrum and sonogram." width="600px" %}
...
{% include img-figure url="/MUTOR/assets/images/earmuffs.png" description="Ear Muffs" width="200px" %}
...
{% include img-figure url="/MUTOR/assets/images/protection_attenuation.png" description="Protection Attenuation" width="500px" %}
