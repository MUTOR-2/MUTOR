...
summary: In this unit we will explain how does it works the biological process of hearing. We will cover the structure and function of the auditory system focusing on the elements that allow us to conceivd hearing as an actively perceiving process, more than just a passive response to a phisical stimulus. We will also compare our musical system with other species. and try to understand when and why the auditory system malfunctions and how to protect our own hearing. 
