...
# TheEar
An overview of the auditory periphery. (image source: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/ear.html)

BrainstemPathways and
An overview of the afferent auditory pathway in the central nervous system. 
...
{% include figure url="/MUTOR/MUTOR-1_0-CNMAT/unit3/ear.gif" description="ear diagram" %}
...
MUTOR TiddlyWiki - Unit 3 on The Auditory System file:///Users/ploui/Documents/Classes/MUTOR/unit3 local/unit3...
...
{% include figure url="/MUTOR/MUTOR-1_0-CNMAT/unit3/bekesy.png" description="bekesy" %}
...
(image source: http://www.physiology.wisc.edu A. Jeffress's (1948) model of coincidence detection. B. Coincidence detectors for computing interaural time differences /yin/jorissmithyin98.pdf)
...
(image source: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/audiom.html) 
...
source: Rossing et al. 2001) Hair cell damage

(image source: http://www.hei.org/education/health/loss.htm) Normal versus damaged hair cells

Audiogram showing presbyacusis, commonly observed as a "ski-slope" hearing loss, where "ski-slope" refers to the shape of the audiometry function, which is relatively intact at low frequencies, but falls off rapidly at high frequencies.
...
# Quiz Items
1. Layouttheanatomyoftheauditorypathway,fromthecochleatotheprimaryauditorycortex.
1. Howdoesthestructureofthebasilarmembranereinforceitsfunction?
1. Whichofthefollowingismostheavilyimplicatedinbeingabletoperceivelocationofsoundsources?
