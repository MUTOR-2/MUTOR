...
{% include img-figure url="/MUTOR/assets/unit3/aud_anatomy_overview.png" description="The Auditory Pathway" %}

An overview of the auditory periphery. 

{% include img-figure url="/MUTOR/assets/unit3/ear_overview.png" description="The Ear" %}
(image source: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/ear.html)
...
Overview of the ear, showing the outer, middle, and inner ear. (image source: Rossing et al, 2001)
...
The middle ear. (image source: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/ear.html)
...
{% include img-figure url="/MUTOR/assets/unit3/ossicles_model.gif" description="Middle Ear Ossicles" %}

A model of the middle ear ossicles
...
{% include img-figure url="/MUTOR/assets/unit3/innerear.gif" description="Inner Ear" %}

The inner ear. (image source: http://hyperphysics.phy-astr.gsu.edu/Hbase/sound/eari.html)
...
{% include img-figure url="/MUTOR/assets/unit3/cochlea_dissected.png" description="Cochlea Dissected" %}

(image source: http://www.iurc.montp.inserm.fr/cric/audition/english /cochlea/fcochlea.htm)
  
A dissected cochlea of a human fetus.

{% include img-figure url="/MUTOR/assets/unit3/cochlea_diagram.png" description="Cochlea Cross-section" %}
...
{% include img-figure url="/MUTOR/assets/unit3/organofcorti.png" description="Organ of Corti" %}

Organ of Corti

{% include img-figure url="/MUTOR/assets/unit3/organofcorti_states.png" description="States of the Organ of Corti" %}

Inhibition and excitation of the organ of corti. a) Inhibition. b) Excitation.
...
{% include img-figure url="/MUTOR/assets/unit3/ihc_mvnt.png" description="inner hair cells" %}

Close-up of inner hair cells with stereocilia, which open when excited by incoming sound.

{% include img-figure url="/MUTOR/assets/unit3/ihc_ohc.png" description="inner and outer hair cells" %}

Electron microscropy showing one row of inner hair cells and three rows of outer hair cells.
...
{% include img-figure url="/MUTOR/assets/unit3/basilar_unrolled.gif" description="basilar membrane unrolled" %}
(image source: http://www.cs.indiana.edu/~port/teach/641/hearing.for.linguists.html) Drawing of the unrolled cochlea, showing the basilar membrane.

{% include img-figure url="/MUTOR/assets/unit3/animated_basilar.gif" description="basilar membrane traveling wave animation" %}
(image source: http://www.cs.indiana.edu/~port/teach Animation of a wave travelling down the basilar membrane.
/641/hearing.for.linguists.html)

{% include img-figure url="/MUTOR/assets/unit3/tonotopy.png" description="tonotopy basilar membrane" %}
(image source: Watts, 1993) Schematic of the rolled-up basilar membrane, with its optimally sensitive frequencies marked along its length.

{% include img-figure url="/MUTOR/assets/unit3/bekesy.png" description="von Bekesy data on tonotopy" %}
(image source: http://www.pbrc.hawaii.edu/bekesy/ taken from Nobel Lectures Physiology or Medicine 1942 - 1962, Elsevier, 1964, pp. 722-746)
...
{% include img-figure url="/MUTOR/assets/unit3/brainstem_anat.png" description="brainstem anatomy" %}

{% include img-figure url="/MUTOR/assets/unit3/brainstem_diagram.png" description="brainstem diagram" %}
(image source: http://serous.med.buffalo.edu/hearing/ic.html)

Anatomy of the brainstem, with the auditory pathway highlighted.
...
{% include img-figure url="/MUTOR/assets/unit3/cn8.jpg" description="Cranial Nerve VIII" %}

Cranial nerve, with the VIIIth nerve (auditory nerve) in red.
...
{% include img-figure url="/MUTOR/assets/unit3/itd.jpg" description="interaural time difference" %}
{% include img-figure url="/MUTOR/assets/unit3/ild.jpg" description="interaural level difference" %}
Illustrations of the concepts of A) interaural time difference (ITD) and B) interaural level difference (ILD).

{% include img-figure url="/MUTOR/assets/unit3/mso_coincidence1.jpg" description="A. model of coincidence detection" %}
(image source: http://www.physiology.wisc.edu A. Jeffress's (1948) model of coincidence detection. 

{% include img-figure url="/MUTOR/assets/unit3/mso_coincidence2.jpg" description="B. physiological implementation of coincidence detection" %}
B. Coincidence detectors for computing interaural time differences /yin/jorissmithyin98.pdf)
...
{% include img-figure url="/MUTOR/assets/unit3/ic.jpg" description="Inferior Colliculus" %}
(image source: http://serous.med.buffalo.edu/hearing/ic.html) Cross-section of the midbrain, with the inferior colliculi highlighted in blue.
...
{% include img-figure url="/MUTOR/assets/unit3/ttremolo.gif" description="tremolo" %}
Tremolo - a case of amplitude modulation
(image source: http://www.compositiontoday.com/sound_bank
...
{% include img-figure url="/MUTOR/assets/unit3/mgn.jpg" description="medial geniculus nucleus" %}

The medial geniculate nuclei, shown here in green.
(image source: http://sylvius.com) Also in the thalamus is the Lateral Geniculate Nucleus, responsible for visual capture and orienting.
...
{% include img-figure url="/MUTOR/assets/unit3/audctx1-2.png" description="auditory cortex" %}

(image source: http://serous.med.buffalo.edu/hearing/auditory_cortex.html)
The Sylvian fissure, with the auditory cortex below it.
...
{% include img-figure url="/MUTOR/assets/unit3/a1_a2.jpg" description="auditory cortex" %}
...
{% include img-figure url="/MUTOR/assets/unit3/animal_song.jpg" description="animal songs" %}

(image source: Hauser & McDermott, 2003. Nature Neuroscience.) Some singing animals, and spectrograms of the songs they
make.
...
- Vanilla Fudge
- William Shatner
(video source: http://www.hearnet.com) MeasuringHearingDamage
...
{% include img-figure url="/MUTOR/assets/unit3/audiogram.gif" description="audiogram" %}

An audiogram comparing normal hearing with hearing impairment due to loud noise. (image source:http://www.sfu.ca/sonic-studio/handbook/Audiogram.html)

{% include img-figure url="/MUTOR/assets/unit3/audiogram_presby.gif" description="audiogram presbyacusis" %}
{% include img-figure url="/MUTOR/assets/unit3/audiogram_familiar.jpg" description="auditory familiar sounds" %}

Sample audiograms: a) audiogram showing presbyacusis, commonly observed as a "ski-slope" hearing loss (see TypesofHearingLoss). b) Audiograms of other types of hearing loss caused by sudden sounds. Curves are normalized according to the equal-loudness contours (see Fletcher-Munson curves from the previous unit).
...
{% include img-figure url="/MUTOR/assets/unit3/normalvsdamaged.jpg" description="hair cell normal vs. damaged" %}

(image source: http://www.hei.org/education/health/loss.htm) Normal versus damaged hair cells

{% include img-figure url="/MUTOR/assets/unit3/audiogram_presby.gif" description="presbyacusis audiogram" %}
...
{% include img-figure url="/MUTOR/assets/unit3/earmuffs.jpg" description="ear muffs" %}
{% include img-figure url="/MUTOR/assets/unit3/earplugs.jpg" description="ear plugs" %}
...
{% include img-figure url="/MUTOR/assets/unit3/protection_attenuation.gif" description="protection attenuation" %}
Various types of hearing protection and their noise reduction rates, as a function of frequency. (image source: Rossing, Moore & Wheeler, 2001)
...
# Quiz Items
1. Lay out the anatomy of the auditory pathway, from the cochlea to the primary auditory cortex.
1. How does the structure of the basilar membrane reinforce its function?
1. Which of the following is most heavily implicated in being able to perceive location of sound sources?
a. inferior colliculus
b. cochlea
c. medial geniculat enucleus 
d. superior olivary nuclei
1. Which of the following methods of hearing protection is the most efficient at attenuating sound? 
a. earmuffs
b. cottonearplugs 
c. plasticinserts
