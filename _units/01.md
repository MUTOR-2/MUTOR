...
{% include p/oscillator name=fixedoscillatorname freq="375." type="sine" %}
{% include p/oscillator name=moveableoscillatorname freq="375." type="sine" %}
...
{% include p/xwaveform-spectroscope src="/MUTOR/assets/audios/clar_C5_1SEC.mp3" gain="6000." %}
{% include end-figure %}

{% include begin-figure description="Oboe C5 Time Domain vs Frequeny Domain" %}
{% include p/xwaveform-spectroscope src="/MUTOR/assets/audios/oboe_C5_1SEC.mp3" gain="6000." %}
{% include end-figure %}
