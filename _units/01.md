...
{% include img-figure url="/MUTOR/assets/images/unit1_sin-amp-period.jpg" 
...
{% include img-figure url="/MUTOR/assets/images/unit1_sin-cos-90phase.jpg" 
...
{% include audio-figure src="/MUTOR/assets/audios/clar_C5_1SEC.mp3" description="Clarinet C5 Time Domain" %}
{% capture fig_waveform %}{{ fignum }}{% endcapture %}

{% include audio-figure src="/MUTOR/assets/audios/oboe_C5_1SEC.mp3" description="Oboe C5 Time Domain" %}
{% capture fig_waveform %}{{ fignum }}{% endcapture %}
