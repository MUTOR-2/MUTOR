...
<div style="display: block; text-align: center; float: center">
<iframe width="560" height="315" src="https://elearning.hfmt-hamburg.de/pluginfile.php/7165/mod_page/content/6/ENIAC.png" 
frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; 
picture-in-picture" allowfullscreen></iframe>
</div>
...
{% include p/xwaveform-spectroscope src="/MUTOR/assets/audios/clar_C5_1SEC.mp3" gain="1.0" %}
{% include end-figure %}

{% include begin-figure description="Oboe C5 Time Domain vs Frequeny Domain" %}
{% include p/xwaveform-spectroscope src="/MUTOR/assets/audios/oboe_C5_1SEC.mp3" gain="1.0" %}
{% include end-figure %}
