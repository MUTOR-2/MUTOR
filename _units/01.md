...
{% include p/begin %}
{% include p/buffer name="mybuf" src="/MUTOR/assets/audios/trombone.mp3" %}
...
{% include p/buffer name=buffername src="/MUTOR/assets/audios/trombone.mp3" %}
...
{% include p/spectroscope name=spectroscopename width="295px" gain="7500" %}
{% include p/sonogram name=sonogramname width="295px" %}
