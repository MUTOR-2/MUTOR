...
{% include begin-figure description="Clarinet Fortissimo C5" %}
{% include begin-audio-example %}
{% include audio-buffer name="mybuf1" src="/MUTOR/assets/audios/clar_C5_1SEC.mp3" %}
{% include audio-player name="player" buffer="mybuf1" %}
<table><tr><td>
{% include begin-overlay width="300px" height="200px" %}
{% include audio-waveform name="waveform" buffer="mybuf1" %}
{% include audio-playhead name="playhead" player="player" %}
{% include end-overlay %}
</td><td>
{% include audio-meter name="meter" %}
