...
phase and frequency determine how they sound. When they have the same
...
of a signal is useful for certain things, but getting a sense of the 
frequency content by looking at it can be misleading.
...
The frequency domain represention of a signal is often referred to as its
*spectrum*. 
...
We now have a more clear view of the frequency composition of a signal.
