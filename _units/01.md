...
{% endcomment %}
{% include begin-figure description="A waveform" %}
{% include p/xwaveform src="/MUTOR/assets/audios/unit1_welcome.wav" %}
{% include end-figure %}
...
{% include p/spectroscope name=spectroscopename width="295px" gain="6000" %}
...
{% include begin-figure description="Clarinet C5 Time Domain" %}
{% include p/xwaveform src="/MUTOR/assets/audios/clar_C5_1SEC.mp3" %}
{% include end-figure %}
{% capture fig_waveform %}{{ fignum }}{% endcapture %}

{% include begin-figure description="Oboe C5 Time Domain" %}
{% include p/xwaveform src="/MUTOR/assets/audios/oboe_C5_1SEC.mp3" %}
{% include end-figure %}
{% capture fig_waveform %}{{ fignum }}{% endcapture %}
