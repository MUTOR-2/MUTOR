...
Click [here for a demo patch](https://github.com/MUTOR-2/MUTOR/raw/master/assets/patches/unit10/betting.maxpat) of the probe tone paradigm. 

Some typical profiles are shown here (see also sections 6 and 7 in Unit 5: Pitch, Intervals and Key Areas):
