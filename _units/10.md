...
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit10_Cmandemo.wav" gain="1.0" %}
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit10_CmaD3demo.wav" gain="1.0" %}
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit10_CmaD5demo.wav" gain="1.0" %}
...
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit10_twinkle1.mp3" gain="1.0" %}

What would you expect to hear next?
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit10_twinkle2.mp3" gain="1.0" %}
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit10_twinkle3.mp3" gain="1.0" %}
{% include p/xwaveform-spectroscope-small src=" /MUTOR/assets/audios/unit10_twinkle4.mp3" gain="1.0" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_jones1.png" description="Jones 1" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_jones2.gif" description="Jones 2" width="300px" %}
(image source: Huron, 2006)

Rhythmic Expectancy Curve showing optimal perceptual performance when the target note is at the expected downbeat. 

{% include img-figure url="/MUTOR/assets/images/unit10_jones_exp_curve.gif" description="Jones exp curve" width="500px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_probetoneprofiles1.png" description="Probe Tone profiles1" width="500px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_balinese_correlations.jpg" description="balinese correlations" width="500px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_rt-harm-priming2.png" description="rt-harm-priming2.png" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_head_turn_lit.gif" description="head_turn_lit.gif" width="200px" %}
{% include img-figure url="/MUTOR/assets/images/unit10_head_turn_unlit.gif" description="head_turn_unlit.gif" width="200px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_tonegroups.png" description="saffran_tonegroups.png" %}
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_transprob.png" description="saffran_transprob.png" %}
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_tonestream.png" description="saffran_tonestream.png" %}
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_testitems.png" description="saffran_testitems.png" width="400px" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_stats1.png" description="saffran_stats1.png" width="350px"%}
...
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_stats2.png" description="saffran_stats2.png" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_stats3.png" description="saffran_stats3.png" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_besson95stim.png" description="besson95stim.png" %}
