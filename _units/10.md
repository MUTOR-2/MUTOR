...
{% include img-figure url="/MUTOR/assets/images/unit10_jones2.png" description="Jones 2" width="300px" %}
(Adapted from: Huron, 2006)

Rhythmic Expectancy Curve showing optimal perceptual performance when the target note is at the expected downbeat. 

{% include img-figure url="/MUTOR/assets/images/unit10_jones_exp_curve.png" description="Jones exp curve" width="500px" %}
{% comment %}
