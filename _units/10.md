...
summary: Expectation and anticipation are important and evolutionarily advantageous characteristics of our cognitive system. In music, expectations feature prominently in our perception of melody, harmony, and rhythm. The systematic violation of expectation seems to lead to arousal and affect in our musical experience. The Implication Realization Model and Gap Fill are rather precise models that can be used to predict what is or is not expected in musical melodies, whereas the Dynamic Attention Theory is an account for our expectancies for rhythm. Musical expectancies have been observed using many convergent methods. These methods include production, betting paradigm, probe tone ratings, comparative ethnomusicology, reaction time methodology, the head turn paradigm, and Event-Related Potentials. Statistics in music seem to play an important role in musical composition, where we generally expect musical events that occur with high frequencies and transitional probabilities in a musical style. #just copied the summary from below. --> We are not being able to use two paragraphs.  
authors: 
- Psyche Loui
...
<audio controls src="/MUTOR/assets/audios/unit10_Cmandemo.wav"> </audio>
<audio controls src="/MUTOR/assets/audios/unit10_CmaD3emo.wav"> </audio>
<audio controls src="/MUTOR/assets/audios/unit10_CmaD5emo.wav"> </audio>
{% include img-figure url="/MUTOR/assets/audios/unit10_Cmandemo.wav" description="Cmajor normal" %}
{% include img-figure url="/MUTOR/assets/audios/unit10_CmaD3demo.wav" description="Cmajor normal" %}
{% include img-figure url="/MUTOR/assets/audios/unit10_CmanD5emo.wav" description="Cmajor normal" %}
...
{% raw %}
{% include img-figure url="/MUTOR/assets/images/unit10_boy-run-ball.jpg" description="Boy running after ball" %}
{% endraw %}
 (image source: http://save-u.org)
...
What would you expect to hear next?
    <audio controls src="/MUTOR/assets/audios/unit10_twinkle1.mp3">
    <audio controls src="/MUTOR/assets/audios/unit10_twinkle2.mp3">
    <audio controls src="/MUTOR/assets/audios/unit10_twinkle3.mp3">
    <audio controls src="/MUTOR/assets/audios/unit10_twinkle4.mp3">
      Your browser does not support the audio element.
    </audio>
    <p>Demo Normal Hearing vs. High-Frequency Hearing loss</p>
1. {% include img-figure url="/MUTOR/assets/audios/unit10_twinkle1.mp3" description="Cmajor normal" %}
1. {% include img-figure url="/MUTOR/assets/audios/unit10_twinkle2.mp3" description="Twinkle2 normal" %}
1. {% include img-figure url="/MUTOR/assets/audios/unit10_twinkle3.mp3" description="Twinkle3 normal" %}
...
To date, a number of theories have been proposed to describe and understand our experience of musical expectation. The first (and perhaps most influential) of such theories is the Expectation-Arousal theory by Leonard Meyer (1956), which generally posits that the systematic violation of expectation leads to arousal. This theory could be applied to harmonic, melodic, and rhythmic factors, but is a descriptive theory rather than a formally defined set of predictions.

Meyer's student Narmour (1990) proposed a more formal theory to account for ExpectationForMelody. Narmour's ImplicationRealizationModel defined a formal set of rules, mainly relating each interval to the next.

More recently, Huron (2006) proposed that GapFill and RegressionToTheMean may be a parsimonious account for expectancy in music, which makes similar predictions as Narmour's theory. The relative predictive powers of the ImplicationRealizationModel and GapFill are as yet unclear. 

In another line of research, Jones (2002) proposed the DynamicAttentionTheory to account for ExpectanciesForRhythm. Their model is mostly used to account for rhythmic expectancies such as our internal anticipation for regularities in rhythm and meter.
...
{% include img-figure url="/MUTOR/assets/images/unit10_expvio_models.gif" description="Models of expectation violation" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_VoExp_affect.png" description="Violation of Expectation relates to affect" %}
(image source: Loui & Wessel, 2007)
 
# Expectation For Melody

To date, the most well-specified models for musical expectation mostly refer to expectation for melody. The ImplicationRealizationModel, first proposed by Narmour (1989), is a formal set of rules defining interval directions and sizes in melodies. The many tenets of the ImplicationRealizationModel will be discussed below. In contrast, Huron (2006) has discussed GapFill and RegressionToTheMean as parsimonious theories to account for similar melodic structures.

## Implication Realization Model

Narmour's Implication Realization Model provides a set of predictions for melodic structure. In particular, the IR model looks at interval sizes and directions between notes of a melody. An interval is defined as the difference in pitch between any two successive notes. In the IR model, when given three notes making two intervals, the first interval is defined as the Implication interval, whereas the second interval is the Realization interval. 

{% include img-figure url="/MUTOR/assets/images/unit10_ir.gif" description="Implied and Realized Intervals" %}

{% include img-figure url="/MUTOR/assets/images/unit10_ir1.gif" description="Implied and Realized Intervals checkerboard" %}
...
* Registral Direction – small intervals imply same direction; large intervals imply opposite direction
...
* Closure – realized intervals tend to smaller and in the opposite direction than implied intervals.  

{% include img-figure url="/MUTOR/assets/images/unit10_ir2.gif" description="Implied and Realized Intervals2" %}
{% include img-figure url="/MUTOR/assets/images/unit10_ir3.gif" description="Implied and Realized Intervals3" %}

(image source: Krumhansl, 1995)

## Gap Fill

Gap fill was first proposed by Huron (1990?) as a parsimonious account for interval sizes and directions in melodies. The basic principle of gap fill states that large intervals in a melody imply smaller intervals in the opposite direction. 

{% include img-figure url="/MUTOR/assets/images/unit10_gap_fill.gif" description="Gap Fill" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_jones1.gif" description="Jones 1" %}
(image source: Huron, 2006) 

Cartoon of results from Jones et al, showing heightened perceptual accuracy at the expected onset time:

{% include img-figure url="/MUTOR/assets/images/unit10_jones2.gif" description="Jones 2" %}
(image source: Huron, 2006)

Rhythmic Expectancy Curve showing optimal perceptual performance when the target note is at the expected downbeat. 

{% include img-figure url="/MUTOR/assets/images/unit10_jones_exp_curve.gif" description="Jones exp curve" %}
(image source: Jones et al, 2002).

A model of rhythmic entrainment 

{% include img-figure url="/MUTOR/assets/images/unit10_jones_entrain.gif" description="Jones entrainment model" %}
 (image source: Jones et al, 2002)
...
1. Betting Paradigm
1. Probe Tone Paradigm
1. Comparative Ethnomusicology
...
The production paradigm is perhaps the simplest way to demonstrate expectaition, in which participants are typically presented with a melody or a chord progression, and are asked to either sing the note they expect to hear next, or play the expected note on a keyboard.
...
Click here for a demo of the betting paradigm. 
...
Click here for a demo of the probe tone paradigm. 

Some typical profiles are shown here:

{% include img-figure url="/MUTOR/assets/images/unit10_probetoneprofiles1.png" description="Probe Tone profiles1" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_rt-harm-priming2.gif" description="rt-harm-priming2.gif" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_rt-harm-priming3.gif" description="rt-harm-priming3.gif" %}
 (image source: Bigand et al, 1999)

Results from a harmonic priming paradigm.
...
In the head turn paradigm for musical expectation, the light is usually paired with a speaker which plays different musical sounds. In an experiment using groups of musical tones, Saffran et al (1999) paired groups of three tones together with predictable probabilities. For instance, After hearing a stream of tones with these predictable probabilities between them, infants showed a habituation effect towards groups of tones that had been presented with high transitional probability, but a dishabituation towards tone groups with low transitional probability. These results suggest that infants could learn to expect more probable tone groups. 
 
{% include img-figure url="/MUTOR/assets/images/unit10_head_turn_lit.gif" description="head_turn_lit.gif" %}
{% include img-figure url="/MUTOR/assets/images/unit10_head_turn_unlit.gif" description="head_turn_unlit.gif" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_tonegroups.gif" description="saffran_tonegroups.gif" %}
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_transprob.gif" description="saffran_transprob.gif" %}
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_tonestream.gif" description="saffran_tonestream.gif" %}
{% include img-figure url="/MUTOR/assets/images/unit10_saffran_testitems.gif" description="saffran_testitems.gif" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_stats1.gif" description="saffran_stats1.gif" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_stats2.gif" description="saffran_stats2.gif" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_stats3.gif" description="saffran_stats3.gif" %}
...
{% include img-figure url="/MUTOR/assets/images/besson95stim.gif" description="besson95stim.gif" %}
...
{% include img-figure url="/MUTOR/assets/images/besson95erps.gif" description="besson95erps.gif" %}
 (image source: Besson & Faita, 1995)
...
{% include img-figure url="/MUTOR/assets/images/loui05att.png" description="loui05att.png" %}
...
* Krumhansl, C.L. & Kessler, E.J. (1982). Tracing the dynamic changes in perceived tonal organization in a spatial representation of musical keys. Psychological Review, Vol. 89, No. 4, pp. 334-368. [16 pages] 
...
* David Huron's book on musical anticipation and expectation: Sweet Anticipation.
