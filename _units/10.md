...
{% include img-figure url="/MUTOR/assets/images/unit10_child-chasing-ball.jpg" description="Child running after a ball" %}
...
{% include img-figure url="/MUTOR/assets/images/unit10_expvio_models.png" description="Models of expectation violation" %}
